...
export interface PatientDto {
   ...
   * @example USA
   */
  nationality: PatientDtoNationalityEnum;
   ...
   * @example M
   */
  chest_size: PatientDtoChestSizeEnum;
 ...
 * @enum {string}
 */
export enum PatientDtoNationalityEnum {
  AD = 'AD',
  AE = 'AE',
  AF = 'AF',
  AG = 'AG',
 ...
 * @enum {string}
 */
export enum PatientDtoChestSizeEnum {
  M = 'M',
  L = 'L',
}
/**
 ...
 * @enum {string}
 */
export enum PatientDtoCorsetEnum {
