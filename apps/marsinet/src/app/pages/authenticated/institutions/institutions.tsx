...
import ModalAddClinic from './components/modal-add-clinic';
import {
  AdminApiFactory,
  MyAccountApiFactory,
...
import { Organization } from 'apps/marsinet/src/app/models/organizationModel';
...
export function Institutions(props: InstitutionsProps) {
  ...
  const { access_token, setRole, role, setAdmin } = useContext(MarsinetContext);
