...
import AreaChartCustom from 'apps/marsinet/src/app/components/area-chart/area-chart';
import ConfigPatient from 'apps/marsinet/src/app/components/config_patient/dashboard';
import MultiLineChart from 'apps/marsinet/src/app/components/multi-line-chart/multi-line-chart';
import { IngestionApiFactory } from 'apps/marsinet/src/app/typescript-axios';
...
import {
  ...
  ElevCtrl,
  MotorsInt,
} from 'apps/marsinet/src/app/models/graphsModels';
