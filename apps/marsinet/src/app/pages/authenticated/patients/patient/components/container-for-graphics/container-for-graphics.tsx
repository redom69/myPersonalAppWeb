...
import GraphStepsDistribution from './components/graph-steps-distribution/graph-steps-distribution';

import { useTranslation } from 'react-i18next';
import { Checkbox } from 'primereact/checkbox';
import { useState } from 'react';

import GraphScore from './components/graph-score/graph-score';
import GraphSteps from './components/graph-steps/graph-steps';
import GraphTime from './components/graph-time/graph-time';
import GraphCadence from './components/graph-cadence/graph-cadence';
